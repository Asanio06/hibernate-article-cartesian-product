...
@Service
@Primary
@Profile("cartesian_product")
public class MovieServiceWithCartesianProductImpl implements MovieService {

    private final EntityManager entityManager;


    public MovieServiceWithCartesianProductImpl(EntityManager entityManager) {
